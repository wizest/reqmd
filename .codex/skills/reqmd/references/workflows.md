...
4. Run `python .codex\skills\reqmd\scripts\reqmd_fix.py <root>`.
...
7. Run `python .codex\skills\reqmd\scripts\reqmd_fix.py <root>`.
...
6. Run `python .codex\skills\reqmd\scripts\reqmd_fix.py <root>`.
...
8. Run `python .codex\skills\reqmd\scripts\reqmd_fix.py <root>`.
...
2. Run `python .codex\skills\reqmd\scripts\analyze_impact.py <root> <identifier-or-helper> [...]`.
