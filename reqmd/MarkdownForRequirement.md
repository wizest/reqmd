...
식별자 색인 섹션에 포함된 링크는 현재 섹션의 식별자와 관계가 있는 항목입니다. 원문 문서를 가리키는 링크도 고정 라벨 대신 현재 식별자 문자열을 그대로 표시합니다. 관계의 종류는 링크 대상의 경로, 문서 위치, 주변 설명, 프로젝트 맥락으로 해석합니다. 색인 파일은 기본적으로 관계 타입을 강제하지 않습니다.
...
도움자 색인 섹션에 포함된 링크는 현재 섹션의 도움자와 연결된 항목입니다. 원문 문서를 가리키는 링크도 고정 라벨 대신 현재 도움자 문자열을 그대로 표시합니다. 연결의 종류는 링크 대상의 경로, 문서 위치, 주변 설명, 프로젝트 맥락으로 해석합니다. 색인 파일은 기본적으로 연결 타입을 강제하지 않습니다.
...
- [brake_lamp_request_signal](../swdd/=)
